    ...
    if(srchPosts){
        srchPosts.forEach(post => {
            ...
            postContent.append(postIdention)
               ...
               edit.innerHTML = `<i class="fas fa-pen icon icon-bookmark" style="color: black; font-size: 14px;"></i>`
        
               edit.addEventListener('click', (e) => {
                window.location.href = './html/edit-post.html?id=' + idPost;
               })
               ...
               delate.addEventListener('click',(event) => {
                ...
                bottom.append(details, delate, edit)
